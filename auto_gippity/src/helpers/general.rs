...
const CODE_TEMPLATE_PATH: &str = "/workspaces/rust-openai_agent/web_template/src/code_template.rs";
pub const WEB_SERVER_PROJECT_PATH: &str = "/workspaces/rust-openai_agent/web_template/";
pub const EXEC_MAIN_PATH: &str = "/workspaces/rust-openai_agent/src/main.rs";
const API_SCHEMA_PATH: &str = "/workspaces/rust-openai_agent/auto_gippity/schemas/api_schema.json";
